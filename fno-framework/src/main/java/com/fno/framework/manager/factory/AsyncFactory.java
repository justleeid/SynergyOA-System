...
import com.fno.system.domain.SysOperLog;
import com.fno.system.service.ISysLogininforService;
import com.fno.system.service.ISysOperLogService;
            ...
            final Object... args)
    {
        ...
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                s.append(LogUtils.getBlock(tenantId));
                // 打印信息到日志
