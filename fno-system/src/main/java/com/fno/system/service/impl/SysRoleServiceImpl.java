...
import com.fno.system.domain.SysRoleDept;
import com.fno.system.domain.SysRoleMenu;
import com.fno.system.domain.SysUserRole;
import com.fno.system.mapper.*;
import com.fno.system.mapper.*;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public List<SysRole> selectRoleList(SysRole role)
    {
        ...
        if(SecurityUtils.isSuperAdmin()){
            result.add(roleMapper.selectRoleById(new Long(1)));
        }
