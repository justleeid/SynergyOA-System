package com.fno.back.workflow.service.flowImg;
...
/**
 * @Description: CustomProcessDiagramGenerator
 * @Author: 丶Lion
 * @Date: 2019/10/15 0015 9:52
 * @Version 1.0
 */
public class CustomProcessDiagramGenerator implements ProcessDiagramGenerator {
    private static final Logger LOG = LoggerFactory.getLogger(CustomProcessDiagramGenerator.class);
